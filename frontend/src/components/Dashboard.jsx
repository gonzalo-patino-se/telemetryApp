...
const Dashboard = () => {
    ...
    const [etpConnectionStatusAutoFetch, setEtpConnectionStatusAutoFetch] = useState(true);
    const [etpConnectionStatusFetchSignal, setEtpConnectionStatusFetchSignal] = useState(0);

    // BGCS Grid Relay Status
    const [bgcsRelayStatusAutoFetch, setBgcsRelayStatusAutoFetch] = useState(true);
    const [bgcsRelayStatusFetchSignal, setBgcsRelayStatusFetchSignal] = useState(0);
    ...
    const [loadCurrentL2AutoFetch, setLoadCurrentL2AutoFetch] = useState(true);
    const [loadCurrentL2FetchSignal, setLoadCurrentL2FetchSignal] = useState(0);
    ...
    return (
        <DashboardLayout showFilters={false}>
            ...
            {/* ==================== LOAD MEASUREMENTS (INVERTER'S ACPORT) ==================== */}
            <CollapsibleSection
                title="Load Measurements (INVERTER'S ACPORT)"
